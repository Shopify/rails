  ...
  class Engine
    class LazyRouteSetTest < ActiveSupport::TestCase
      ...
      test "mounted helpers module of the lazy route set exposes helpers defined by mount" do
        ...
        # ActionView::TestCase#method_missing forwards mounted helpers based
        # on this reflection.
        ...
        # Only mounted helpers are mirrored: UrlFor stays a Concern dependency,
        # so its methods must not leak into the reflection that
        # ActionView::TestCase forwards on.
