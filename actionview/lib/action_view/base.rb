...
module ActionView # :nodoc:
  ...
  class Base
    ...
    class_attribute :field_error_proc, default: Proc.new { |html_tag, instance| content_tag :div, html_tag, class: "field_with_errors" }

    # How to complete the streaming when an exception occurs.
    # This is our best guess: first try to close the attribute, then the tag.
    class_attribute :streaming_completion_on_exception, default: %("><script>window.location = "/500.html"</script></html>)
    ...
    class_attribute :default_formats

    # Specify whether submit_tag should automatically disable on click
    class_attribute :automatically_disable_submit_tag, default: true
    ...
    class_attribute :remove_hidden_field_autocomplete, default: false
