  ...
  class Base
    ...
    class << self
      ...
      def with_empty_template_cache # :nodoc:
        ...
        subclass.define_method(:compiled_method_container, &compiled_method_container)
        subclass.define_singleton_method(:compiled_method_container, &compiled_method_container)
        subclass
      end
