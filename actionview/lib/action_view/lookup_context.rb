...
module ActionView
  ...
  class LookupContext # :nodoc:
    ...
    class Details
      ...
      # Same match semantics as +template_rank+ without computing a rank:
      # a single candidate doesn't need ordering, so this tests the axis
      # arrays directly and skips the ranks cache.
