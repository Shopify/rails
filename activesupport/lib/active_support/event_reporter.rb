...
module ActiveSupport
  ...
  #
  # If an {event object}[rdoc-ref:EventReporter@Event+Objects] is given instead, and using one of the {default encoders}[rdoc-ref:EventReporter@Default+Encoders], it will be filtered at encode time.
  #
  # If you're using event objects and **not** relying on the provided encoders, subscribers will need to filter sensitive data themselves, e.g. with ActiveSupport::ParameterFilter.
  class EventReporter
