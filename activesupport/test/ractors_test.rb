...
class KernelRactorShareabilityTest < ActiveSupport::TestCase
  if RUBY_VERSION >= "4.0"
    ...
    def test_shareable_proc_attempt_when_action_is_nil
      old = ActiveSupport::Ractors.unshareable_proc_action
      ActiveSupport::Ractors.unshareable_proc_action = nil

      proc = -> { }
      attempted = ActiveSupport::Ractors.shareable_proc_attempt(proc)
    ...
    def test_shareable_proc_attempt_creates_a_shareable_proc
      old = ActiveSupport::Ractors.unshareable_proc_action
    ...
    def test_shareable_proc_attempt_raises
      old = ActiveSupport::Ractors.unshareable_proc_action
      ActiveSupport::Ractors.unshareable_proc_action = :raise
      ...
      assert_raises(Ractor::IsolationError) do
        ActiveSupport::Ractors.shareable_proc_attempt(proc)
      end
    ensure
      ActiveSupport::Ractors.unshareable_proc_action = old
    end

    def test_shareable_proc_attempt_warns
      old = ActiveSupport::Ractors.unshareable_proc_action
