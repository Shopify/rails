  ...
  module Attached::Model
    ...
    class_methods do
      ...
      def has_one_attached(name, dependent: :purge_later, service: nil, strict_loading: false, analyze: nil)
        ...
        has_one :"#{name}_attachment", -> { where(name: frozen_name) }, class_name: "ActiveStorage::Attachment", as: :record, inverse_of: :record, dependent: :destroy, strict_loading: strict_loading
      ...
      def has_many_attached(name, dependent: :purge_later, service: nil, strict_loading: false, analyze: nil)
        ...
        frozen_name = name.to_s.freeze
        has_many :"#{name}_attachments", -> { where(name: frozen_name) }, as: :record, class_name: "ActiveStorage::Attachment", inverse_of: :record, dependent: :destroy, strict_loading: strict_loading
