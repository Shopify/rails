...
module ActiveRecord
  module ConnectionAdapters
    # Worker-Ractor proxy for a concrete adapter. It runs the ordinary
    # worker-side query pipeline locally and forwards everything else to
    # a token-pinned connection on the main Ractor.
    class RactorConnectionProxy < AbstractAdapter # :nodoc:
      ...
      # Main-Ractor-only registry of token-pinned connections. Pool
      ...
      class << self
        ...
        # Identity token of a main-Ractor pool instance. Re-establishing a
        ...
        # Whether the token still names a live, checked-out main ractor
