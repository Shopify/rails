    ...
    class PostgreSQLAdapter < AbstractAdapter
      ...
      private
        ...
        def column_definitions(table_name)
          ...
          if fields.empty? && query_value("SELECT to_regclass(#{quote(quote_table_name(table_name))})").nil?
            raise ActiveRecord::StatementInvalid.new("Could not find table '#{table_name}'", connection_pool: @pool)
          end
          fields
        end
