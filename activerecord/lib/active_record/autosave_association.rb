  ...
  module AutosaveAssociation
    ...
    private
      ...
      def validate_has_one_association(reflection)
        ...
        return if record.validating_belongs_to_for?(inverse_association) || record.autosaving_belongs_to_for?(inverse_association)
      ...
      def save_has_one_association(reflection)
        ...
        if autosave && record.marked_for_destruction?
          ...
          inverse_association = reflection.inverse_of && record.association(reflection.inverse_of.name)
          return if record.autosaving_belongs_to_for?(inverse_association)
