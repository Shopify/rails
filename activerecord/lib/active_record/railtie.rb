      ...
      config.after_initialize do
        if app.config.active_record.query_log_tags_enabled
          ...
          ActiveRecord::QueryLogs.taggings.merge!(
            ...
            socket:       ->(context) { context[:connection].poll.db_config.socket },
            db_host:      ->(context) { context[:connection].poll.db_config.host },
            database:     ->(context) { context[:connection].poll.db_config.database }
          )
